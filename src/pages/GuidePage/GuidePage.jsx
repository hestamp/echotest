    ...
    <div className={styles.mainguide}>
      ...
      >
        <div className={styles.slide}>
          ...
          <p>
            Unlock the power of your mind with spaced repetition. Just like an
            echo, each piece of information in your learning journey will
        ...
        <div className={styles.slide}>
          ...
          <img className={styles.logoimg} src="/guide/guide.calendar.webp" />
          <p>
            Create a new echo and segment it for intervals of repetition. Your
            echoes will fill a calendar, sparing you the effort of remembering
            when to revisit each one
          </p>
        </div>
        <div className={styles.slide}>
        ...
        <div className={styles.slide}>
          ...
          <button className={styles.bigButt} onClick={handleGuideCompletion}>
            Get ready!
          </button>
        </div>
      </CustomSlider>
